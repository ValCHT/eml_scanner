...
**Amendement opérateur (2026-09-21) :** aucun benchmark complet (83 emails dev, gold_test, Visual-79) n'est exécuté comme validation T14–T18 ; ces tickets utilisent uniquement des samples/smokes bornés. Le premier benchmark complet est **TICKET-19**. Le ticket 18 devient un smoke de freeze/readiness/reproducibilité pré-T19 ; si G7 n'est pas retenu, exécuter 19 après 14. Les tickets 15 et 16 sont indépendants fonctionnellement mais exécutés séquentiellement pour garder une attribution claire des effets. La capacité technique d'évaluation du corpus complet reste disponible et sera réutilisée par T19 ; elle n'est simplement pas exécutée comme validation T14–T18.
